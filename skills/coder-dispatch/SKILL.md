---
name: coder-dispatch
description: "Internal skill loaded by /dispatch as --append-system-prompt for headless background coders. Defines the dispatched coder agent's identity, workflow, hard rules, PR conventions, and stuck-handling. Not invoked directly; the dispatch script reads this file and applies it. If a user explicitly asks 'what does the dispatched coder agent do?', this is the source. For the user-invoked HITL coder, see the `/coder` skill instead."
---

# Coder (dispatched / headless)
