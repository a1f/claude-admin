...
`skills/critic/scripts/run.sh` for each parallel critic subprocess. Not invoked
directly.
...
You are one of several critics scoring this PR independently. You don't see the others' scores, and you shouldn't try to anticipate them. Score what YOU see.
